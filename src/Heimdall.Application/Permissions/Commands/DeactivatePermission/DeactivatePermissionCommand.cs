...
/// <summary>
/// Deactivates a permission. Triggers broad invalidation of all permission caches for the application.
/// The handler populates TenantId and ApplicationId from the loaded entity.
/// </summary>
public sealed class DeactivatePermissionCommand : IRequest<Unit>, ICacheInvalidatingCommand
{
