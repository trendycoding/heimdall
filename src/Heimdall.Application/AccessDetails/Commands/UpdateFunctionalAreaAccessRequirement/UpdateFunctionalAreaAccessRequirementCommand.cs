...
/// <summary>
/// Updates a functional area access requirement. Invalidates access detail cache for the application.
/// The handler populates TenantId and ApplicationId from the loaded entity.
/// </summary>
public sealed class UpdateFunctionalAreaAccessRequirementCommand : IRequest<Unit>, ICacheInvalidatingCommand
{
